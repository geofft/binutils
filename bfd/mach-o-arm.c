/* Intel ARM Mach-O support for BFD.
...
{
  return bfd_mach_o_header_p (abfd, 0, BFD_MACH_O_CPU_TYPE_ARM);
}
...
static bfd_boolean
bfd_mach_o_arm_swap_reloc_out (arelent *rel, bfd_mach_o_reloc_info *rinfo)
{
                                      ...
                                      bfd_reloc_code_real_type code)
{
  ...
  for (i = 0;
       i < sizeof (arm_howto_table) / sizeof (*arm_howto_table);
       i++)
...
static bfd_boolean
bfd_mach_o_section_type_valid_for_arm (unsigned long val)
{
...
const mach_o_segment_name_xlat mach_o_arm_segsec_names_xlat[] =
  {
    { "__TEXT", text_section_names_xlat },
    { NULL, NULL }
  };

#define bfd_mach_o_swap_reloc_in bfd_mach_o_arm_swap_reloc_in
#define bfd_mach_o_swap_reloc_out bfd_mach_o_arm_swap_reloc_out
...
#define bfd_mach_o_tgt_seg_table mach_o_arm_segsec_names_xlat
#define bfd_mach_o_section_type_valid_for_tgt bfd_mach_o_section_type_valid_for_arm

#define TARGET_NAME 		mach_o_arm_vec
